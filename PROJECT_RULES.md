...
6. ทุกงานที่สำเร็จต้อง commit checkpoint ลง GitHub ก่อนจบรอบ
7. Checkpoint ขั้นต่ำประกอบด้วยโค้ด/ไฟล์งาน, `CURRENT_STATE.md`, `TASK_HISTORY.md`, `CHANGELOG.md` และ QA ที่เกี่ยวข้องตามลักษณะงาน
8. อัปเดต `MASTER_CONTEXT.md` เฉพาะเมื่อกฎถาวร ขอบเขต สถาปัตยกรรม หรือการตัดสินใจหลักเปลี่ยน
